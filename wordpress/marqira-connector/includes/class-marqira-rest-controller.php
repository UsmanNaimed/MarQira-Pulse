...
class Marqira_Rest_Controller {
        ...
        public static function register_routes() {
                ...
                // Unauthenticated, side-effect-free liveness probe used by the recovery
                // health checker to confirm the REST stack still answers. It proves PHP +
                // WordPress + REST executed; it returns no sensitive data.
                register_rest_route(
                        self::NAMESPACE,
                        '/health-ping',
                        array(
                                'methods'             => 'GET',
                                'callback'            => array( __CLASS__, 'handle_health_ping' ),
        ...
        /**
         * Liveness probe. Returns 200 with a tiny payload.
         *
         * @return WP_REST_Response
         */
        public static function handle_health_ping() {
                return new WP_REST_Response(
                        array(
                                'ok'      => true,
                                'service' => 'marqira-connector',
                                'time'    => time(),
                        ),
                        200
                );
